...
const Hero = () => {
  return (
    <section className="bg-gray-100 text-gray-800  flex items-center justify-center min-h-[calc(100vh-96px)]">
      <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
        <h1 className="text-4xl font-bold leading-none sm:text-5xl">
          Quisquam necessita
          <span className="text-violet-600 block mt-4">
            vel laborum doloribus
          </span>
        </h1>
